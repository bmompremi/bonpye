      ...
      <div className="max-w-2xl mx-auto space-y-5 py-2">
        ...
        <div className="flex flex-col items-center gap-3 py-4">
          <div className="relative">
            <img src="/images/bonpye_logo.gif" alt="Bonpye" className="h-20 w-20 object-contain" />
            {/* Spotify logo badge top-right */}
          ...
          <h1 className="text-xl font-bold text-center">Bonpye Soccer Talk</h1>
        </div>
